...
const ResultPage: React.FC = () => {
  ...
  //handle pressing the continue button
  const handleNext = () => {
  ...
  //handle pressing the undo on the auto forwarding modal
  const handleUndo = () => {
    setIsAutoNavigationModalVisible(false);
    handleBack();
  }

  //show auto navigation modal for 5 seconds after automatic forwarding
  useEffect(() => {
    if (showPopup === 'true') {
  ...
  //on page load set the override status to the current value
  useEffect(() => {
  ...
  //determine the risk based on the thresholds
  useEffect(() => {
  ...
  //set override status based on result page override
  useEffect(() => {
  ...
  //set override status based exit popup override
  useEffect(() => {
  ...
  //determine the cue to displayed
  useEffect(() => {
  ...
  //based on the determined cue return the content
